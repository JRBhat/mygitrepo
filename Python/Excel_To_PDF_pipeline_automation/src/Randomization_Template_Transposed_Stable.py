...
def randomize_transp(filelist, randomfilepath, area_id_list, time_id_list, sorted_subject_id_list):
    ...
    derandomized_list = []                         # e.g. ('D:\\STUDIES\\23.0058-6...ntour1.jpg', 'A') ; grouped and sorted according to subjects
    for subj in sorted_subject_id_list:
    ...
    print(final_derandomized_list)                                                      # e.g. ('D:\\STUDIES\\23.0058-6...ntour1.jpg', 'A')
